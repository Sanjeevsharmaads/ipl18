...
public class TeamPunjab extends Team {
	...
	public TeamPunjab(String captainName, String[] foreignPlayers, String[] localPlayers, String runScoreer,
	...
	public void getTeamCheers() {
		System.out.println("Cheer Team is WhiteMisChef");
	...
	public void getCaptainName() {
		...
		System.out.println("Captain of Punjab  is " + captainName);

	}

	public void getBestForeignPlayers() {
		System.out.println("Best Foreign Players of Punjab is :");
	...
	public void getBestLocalPlayers() {
		System.out.println("Best Local Players of Punjab is :");
	...
	public void getHighestRunScoreer() {
		System.out.println("Highest Run Scorrer of Punjab is :" + runScoreer);

	}

	public void getHIghestWicketTakers() {

		System.out.println("Highest Wicket Tacker of Punjab is :" + highestWicketTacker);
	}

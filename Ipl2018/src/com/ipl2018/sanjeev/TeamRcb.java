...
public class TeamRcb extends Team {
	...
	public TeamRcb(String captainName, String[] foreignPlayers, String[] localPlayers, String runScoreer,
	...
	public void getTeamCheers() {
		System.out.println("Cheer Team is Captain Morgan Cola");
	...
	public void getCaptainName() {
		...
		System.out.println("Captain of RCB is " + captainName);

	}

	public void getBestForeignPlayers() {
		System.out.println("Best Foreign Players of RCB is :");
	...
	public void getBestLocalPlayers() {
		System.out.println("Best Local Players of RCB is :");
	...
	public void getHighestRunScoreer() {
		System.out.println("Highest Run Scorrer of RCB is :" + runScoreer);

	}

	public void getHIghestWicketTakers() {

		System.out.println("Highest Wicket Tacker of RCB is :" + highestWicketTacker);
	}
